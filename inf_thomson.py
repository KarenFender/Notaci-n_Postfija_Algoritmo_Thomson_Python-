Notaci-n_Postfija_Algoritmo_Thomson_Python-
===========================================

Un programa hecho en Python 2.7 para convertir de notación infija a notación postfija una expresión regular, y después aplicar algoritmo de Thomson para ver estado iniciales y finales. Básicamente para crear el autómata 
